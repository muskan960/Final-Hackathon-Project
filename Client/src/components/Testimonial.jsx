    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 py-24'>
            <div className='text-center'>
                <h2 className='text-2xl md:text-3xl lg:text-5xl font-bold bg-gradient-to-r from-gray-800 to-gray-500 bg-clip-text text-transparent'>Loved by Creators</h2>
                <p className='text-gray-500 max-w-lg mx-auto mt-3'>Don't just take our word for it. Here's what our users are saying.</p>
            </div>
